...
## Профили производительности (ТЗ 18)

Система рассчитана на работу от Mini PC (Intel N100) до Ryzen 9. Профиль задаёт
связный набор параметров; любой из них можно доопределить вручную в «Настройках».

| Профиль | Железо | Камер | FPS детекции | Пропуск кадров | Модель | Апскейл | Кластеризация |
|---|---|---|---|---|---|---|---|
| Экономный | Intel N100 / Celeron | 4–8 | 5 | каждый 4-й кадр | buffalo_s | только вручную | раз в 60 мин |
| Стандартный | Core i3 / Ryzen 3 | 8–12 | 10 | каждый 2-й кадр | buffalo_s | аватары в фоне | раз в 15 мин |
| Максимальный | Core i5+ / GPU | 12–16 | 15 | без пропуска | buffalo_l | вся галерея | раз в 5 мин |
